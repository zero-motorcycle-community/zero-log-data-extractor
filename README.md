...
Yields output like:
```csv
entry,timestamp,component,event_type,event_level,event,PackTemp (h),PackTemp (l),Vpack,BattAmps,MotTemp,AmbTemp,Odo,vmod,minsys,vcap,prechg,MinCell,MaxPackTemp,PackSOC,MbbChgEn,BmsChgEn,batt curr,Reset,serial,ImpedanceKOhms,Cell,Code,Error Code,Data,Bmvolts,Amps,RPM,CapV
...
19,2018-05-13 10:10:35,MBB,LIMIT,,Batt Dischg Cur Limited,,,,105,,,,,,,,3.28,37,15.217391304347826%,,,,,,,,,,,,,,
